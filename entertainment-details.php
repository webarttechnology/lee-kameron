<?php include("header.php") ?>
    ...
    <!-- banner -->
    <section class="bannerPart innerBanner" style="background:url(images/innerBanner.jpg) no-repeat top left;">
                ...
                <div class="col-md-11 col-lg-10">
                    ...
                    <nav>
                        <ol class="breadcrumb text-uppercase mt-4">
                            ...
                            <li class="breadcrumb-item"><a href="#">Entertainment</a></li>
                            <li class="breadcrumb-item active">ELITE FORCES</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-4">
                            ...
                            <p>BET: Black Entertainment Television</p>
                        </div>
                        <div class="col-sm-6 col-md-4">
